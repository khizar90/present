            ...
            <div class="card">
                <div class="card-header border-bottom">
                    <div class="d-flex justify-content-between">
                        <h5 class="card-title mb-3">Reported Reels</h5>
                        <div class="">
                            ...
                            <tbody id="searchResults">
                                @foreach ($reports as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ $item->reported_reel->media }}" target="_blank">
                                                <video src="{{ $item->reported_reel->media }}" alt="" height="100"
                                                    width="100" class="rounded"></video>
                                            </a>
                                        </td>
                                        <td>{{ $item->message }}</td>
                                        <td class="detailbtn">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end m-0">
                                                ...
                                                <a href="#" data-id="{{ $item->id }}"
                                                    data-post_id="{{ $item->reported_reel->id }}"
                ...
                <div class="modal fade" data-bs-backdrop='static' id="deleteUser" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content deleteModal verifymodal">
                            ...
                            <div class="modal-body">
                                <div class="body">After deleting the user the user will not see this reel
                                </div>
                            </div>
                            <hr class="hr">
    ...
    @section('script')
        ...
        <script>
            $('.deleteUser').click(function(e) {
                ...
                console.log(itemId)
                $('#deleteButton1').attr('href', "/dashboard/report/reel/delete" + "/" +
                    post_id + "/" + itemId);
